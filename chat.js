  ...
  const MediaAppThemeManager = {
    ...
    themeConfig: {
      ...
      light: {
        ...
        navLabelColor:        'rgba(0,0,0,0.35)',
        navBadgeBorder:       '#ffffff',
        // sheets
        sheetBg:              '#ffffff',
        sheetHandle:          '#e0e0e0',
        sheetBorder:          '#f2f2f2',
      ...
      dim: {
        ...
        navLabelColor:        'rgba(255,255,255,0.35)',
        navBadgeBorder:       '#15202b',
        sheetBg:              '#1e2732',
        sheetHandle:          '#38444d',
        sheetBorder:          '#38444d',
        inputBg:              '#15202b',
    ...
    applyTheme: function(themeName) {
      ...
      styleEl.textContent = `
        ...
        /* inactive state */
        .nav-btn {
          color: ${t.navLabelColor} !important;
        }
        .nav-btn .nav-icon-wrap svg {
          stroke: ${t.navIcon} !important;
        }
        /* active pill */
        .nav-btn.active {
          background: ${t.navActiveBg} !important;
          color: ${t.navIconActive} !important;
        }
        .nav-btn.active .nav-icon-wrap svg {
          stroke: ${t.navIconActive} !important;
        }
        .nav-btn.active .nav-icon-wrap svg.fill-icon {
          fill: ${t.navIconActive} !important;
          stroke: none !important;
        }
        /* upload tile */
        .nav-upload-pill {
          background: ${t.navUploadBg} !important;
          box-shadow: 0 4px 10px rgba(0,0,0,0.18) !important;
        }
        .nav-upload-pill svg {
          stroke: ${t.navUploadIcon} !important;
        }
        /* upload + inactive labels */
        .nav-upload-label {
          color: ${t.navLabelColor} !important;
        }
        /* badge border matches nav bg */
        .nav-badge {
          border-color: ${t.navBadgeBorder} !important;
        }
        ...
        #liked-section { background: ${t.surfaceSecondary} !important; }
        #liked-header { background: ${t.surfacePrimary} !important; border-bottom: 1px solid ${t.border} !important; }
        ...
        #liked-back-btn svg { stroke: ${t.textPrimary} !important; }
        #liked-back-btn { background: ${t.surfaceHover} !important; }
        .liked-cell { background: ${t.surfaceHover} !important; box-shadow: 0 1px 6px rgba(0,0,0,0.12) !important; }
        #liked-empty-icon { background: ${t.surfaceHover} !important; }
        ...
        @media (min-width: 900px) {
          ...
          .upd-tab { background: ${t.updTabBg} !important; border-color: ${t.updTabBorder} !important; color: ${t.updTabColor} !important; }
          .upd-tab svg { stroke: ${t.updTabColor} !important; }
          .upd-tab.active { background: var(--brand-gradient) !important; color: #ffffff !important; border-color: transparent !important; box-shadow: 0 4px 14px rgba(0,0,0,0.18) !important; }
          .upd-tab.active svg { stroke: #ffffff !important; }
          #updates-list { background: ${t.updBg} !important; }
          ...
          #dp-col { background: ${t.sidebarBg} !important; box-shadow: 0 2px 20px rgba(0,0,0,0.07) !important; }
          #dp-head { background: ${t.sidebarBg} !important; border-bottom-color: ${t.dsDivider} !important; }
          #dp-cover { background: var(--brand-gradient); }
          #dp-bio { color: ${t.textSecondary} !important; }
          #dp-links a { background: ${t.surfacePrimary} !important; color: ${t.textPrimary} !important; }
          ...
          #dp-tabs { border-top-color: ${t.dsDivider} !important; }
          ...
          #dp-tab-uploaded, #dp-tab-liked, #dp-tab-superliked { color: ${t.textTertiary} !important; }
          #dp-tab-uploaded[style*="border-image"], #dp-tab-liked[style*="border-image"], #dp-tab-superliked[style*="border-image"] { color: ${t.textPrimary} !important; }
          ...
          #followingPanel.open { background: ${t.sidebarBg} !important; }
          ...
          #followingPanel .fp-user-links .fp-link-pill { background: ${t.surfacePrimary} !important; color: ${t.textPrimary} !important; background-clip: padding-box !important; }
